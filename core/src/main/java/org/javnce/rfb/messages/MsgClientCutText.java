...
/**
 * The Class MsgClientCutText is the ClientCutText RFB message sent by client.
 *
 */
public class MsgClientCutText extends Message {

    /**
     * The Constant msgId.
     */
    final static private Id msgId = Id.ClientCutText;
    /**
     * The Constant type.
     */
    final static private byte type = 6;
    /**
     * The readtype.
     */
    ...
    /**
     * Instantiates a new ClientCutText message for receiving.
     */
    public MsgClientCutText() {
        super(msgId);
    }

    /**
     * Instantiates a new ClientCutText message for sending.
     *
     * @param text the text to be sent
     */
    public MsgClientCutText(String text) {
        super(msgId);
