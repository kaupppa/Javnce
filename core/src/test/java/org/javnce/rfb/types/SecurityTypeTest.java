...
public class SecurityTypeTest {
    ...
    public void testValueOf() {
        assertEquals(SecurityType.Invalid, SecurityType.valueOf("Invalid"));
        assertEquals(SecurityType.None, SecurityType.valueOf("None"));
        assertEquals(SecurityType.UnSupported, SecurityType.valueOf("UnSupported"));
    }
}
